      ...
      <SidebarContent>
            ...
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="Today"
                >
                  <img src="/icons/calendar_128.png" alt="" className="w-7 h-7 shrink-0" />
                  <span>Today</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="Insights"
                >
                  <img src="/icons/idea_128.png" alt="" className="w-7 h-7 shrink-0" />
                  <span>Insights</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="Goals"
                >
                  <img src="/icons/bookmark_128.png" alt="" className="w-7 h-7 shrink-0" />
                  <span>Goals</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="Journal"
                >
                  <img src="/icons/pencil_128.png" alt="" className="w-7 h-7 shrink-0" />
                  <span>Journal</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="flex items-center">
            <img src="/icons/folder_128.png" alt="" className="w-5 h-5 shrink-0 mr-1.5" />
              ...
              {roadmapList.map((r) => (
                <SidebarMenuItem key={r.id}>
                  <div className="group/rm relative flex items-center gap-0.5 pr-1">
                    ...
                    >
                      <img src="/icons/document_128.png" alt="" className="w-7 h-7 shrink-0" />
                      <span>{r.name}</span>
                    </SidebarMenuButton>
                    <button
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="flex items-center">
            <img src="/icons/checklist_128.png" alt="" className="w-5 h-5 shrink-0 mr-1.5" />
