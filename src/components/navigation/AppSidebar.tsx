      ...
      <SidebarContent>
            ...
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="Today"
                >
                  <img src="/icons/calendar_256.png" alt="" className="w-11 h-11 shrink-0" />
                  <span>Today</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="Insights"
                >
                  <img src="/icons/idea_256.png" alt="" className="w-11 h-11 shrink-0" />
                  <span>Insights</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="Goals"
                >
                  <img src="/icons/bookmark_256.png" alt="" className="w-11 h-11 shrink-0" />
                  <span>Goals</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="Journal"
                >
                  <img src="/icons/pencil_256.png" alt="" className="w-11 h-11 shrink-0" />
                  <span>Journal</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="flex items-center">
            <img src="/icons/folder_256.png" alt="" className="w-7 h-7 shrink-0 mr-1.5" />
              ...
              {roadmapList.map((r) => (
                <SidebarMenuItem key={r.id}>
                  <div className="group/rm relative flex items-center gap-0.5 pr-1">
                    ...
                    >
                      <img src="/icons/document_256.png" alt="" className="w-11 h-11 shrink-0" />
                      <span>{r.name}</span>
                    </SidebarMenuButton>
                    <button
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="flex items-center">
            <img src="/icons/checklist_256.png" alt="" className="w-7 h-7 shrink-0 mr-1.5" />
