    ...
    >
      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          ...
          <input
            className="w-full text-sm border border-gray-300 rounded px-3 py-2 outline-none focus:border-blue-500"
            value={item.name}
        ...
        <div>
          ...
          <select
            className="w-full text-sm border border-gray-300 rounded px-3 py-2 outline-none focus:border-blue-500 bg-white"
            value={item.phase}
        ...
        <div>
          ...
          <textarea
            className="w-full text-sm border border-gray-300 rounded px-3 py-2 outline-none focus:border-blue-500 min-h-20 resize-y"
            value={item.notes}
              ...
              {item.phaseBars.map((bar) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    <input
                      type="date"
                      className="text-[10px] border border-gray-300 rounded px-1.5 py-0.5 outline-none focus:border-blue-500"
                      value={bar.startDate}
                      onChange={(e) =>
