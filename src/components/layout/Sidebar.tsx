    ...
    >
      ...
      {showAddStream ? (
        <div className="p-2 border-t border-gray-200">
          <input
            className="w-full text-sm border border-gray-300 rounded px-2 py-1 mb-2 outline-none focus:border-blue-500"
          ...
          <div className="flex gap-1 mt-2">
            <button
              ...
              className="text-xs px-2 py-1 bg-blue-500 text-white rounded border-none cursor-pointer hover:bg-blue-700"
            >
              Add
            </button>
            <button
        ...
        <div
          className="flex items-center px-3 text-sm text-gray-400 hover:text-blue-600 cursor-pointer border-t border-gray-200"
        ...
        <>
          {stream.items.map((item) => (
            <div key={item.id}>
              ...
              {item.expanded && (
                <div
                  className="flex items-center px-2 pl-12 text-xs text-gray-300 hover:text-blue-600 cursor-pointer border-b border-gray-50"
          ...
          <div
            className="flex items-center px-2 pl-8 text-sm text-gray-400 hover:text-blue-600 cursor-pointer border-b border-gray-50"
            style={{ height: ITEM_ROW_HEIGHT }}
