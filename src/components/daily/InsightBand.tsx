...
export function InsightBand() {
  ...
  return (
    <div
      ...
      onClick={() => setOpen((v) => !v)}
    >
      <div className="grid gap-7 items-start" style={{ gridTemplateColumns: '136px minmax(0, 1fr) 170px' }}>
        ...
        <div className="flex flex-col items-end gap-2 min-w-0">
          <span
            className="flex items-center justify-center w-[26px] h-[26px] rounded-lg transition-transform flex-shrink-0"
            style={{
          ...
          {source && (
            <span
              className="o-dot text-[10.5px] text-right w-full overflow-hidden"
              style={{
                color: 'var(--ink-45)',
                display: '-webkit-box',
                WebkitLineClamp: 3,
      ...
      <div
        ...
        style={{
          gridTemplateColumns: '136px minmax(0, 1fr) 170px',
